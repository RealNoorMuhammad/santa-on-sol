    ...
    <section id="creator-rewards" className="creator-rewards">
      <div className="creator-rewards__container">
        <div className="creator-rewards__heading">
          <p className="creator-rewards__eyebrow">Live FEES GENERATED</p>
          <h2>Creator Rewards Tracker</h2>
          <p className="creator-rewards__description">
          Real-time creator rewards generated by the Official Santa Claus Coin wallet on Pump.fun. Updates automatically every 30 seconds so you always know how much the elves have collected
          </p>
        </div>
